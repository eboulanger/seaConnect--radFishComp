...
if (sp == "mul") {
  ...
  adaptive <-"../../../seaConnect--dataPrep/04-finalPrep/02-Mullus/mul_adaptive_[0-9]+.raw" 
...
dapc.clust.best.score <- a.score(dapc.clust.best, n.sim = 1000) # neutral : $mean = 0.4999182 for K = 2, n.pc = 1
     ...
     saveRDS(dapc.clust.best, file = "c-adaptive/DAPC_mul_adaptive_K3.rds")
...
lat_cell <- as.numeric(as.vector(cell_posterior$Latitude))
  ...
  #pdf(file="c-adaptive/DAPCmap_mul_adaptive_K3.pdf", width = 16, height = 9)
